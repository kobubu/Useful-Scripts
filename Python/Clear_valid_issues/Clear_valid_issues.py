...
filename_all = r"all CustomQA_FM翻译需求V6.0-0813-en-20240904182120 FR.xlsx.xlsx"
file_path_all = os.path.join(dir, filename_all)

filename_only_valid = r"CustomQA_FM翻译需求V6.0-0813-en-20240904182120 FR.xlsx.xlsx"
